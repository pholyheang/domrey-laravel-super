                    ...
                    <div class="taxi-banner taxi-banner2 radius-10 mb-20"
                        ...
                        <div class="taxi-info-wrapper d-flex flex-wrap flex-sm-nowrap gap-30px">
                            <div class="logo bg-white rounded-8 h-135px ratio--1 p-10px">
                                <img   src="{{ $store->logo_full_url ?? asset('assets/admin/img/100x100/1.png') }}" width="150" class="rounded-8"
                                    alt="">
                            </div>
                                ...
                                <div class="details row g-xl-4 g-3 justify-content-between">
                                    <div class="col-sm-6 col-lg-4 col-xxl-3">
                                        <div class="details-single d-flex align-items-center gap-2">
                                            <img src="{{ asset('assets/admin/img/icons/s-zone.png') }}" width="36" height="36"
                                                class="rounded" alt="">
                                            <div>
                                    ...
                                    <div class="col-sm-6 col-lg-4 col-xxl-3">
                                        <div class="details-single d-flex align-items-center gap-2">
                                            <img src="{{ asset('assets/admin/img/icons/s-phone.png') }}" width="36" height="36"
                                                class="rounded" alt="">
                                            <div>
                                                <h5 class="lh--12 mb-2px color-3C3C3C">
                                    ...
                                    <div class="col-sm-6 col-lg-4 col-xxl-3">
                                        <div class="details-single d-flex align-items-center gap-2">
                                            <img src="{{ asset('assets/admin/img/icons/s-email.png') }}" width="36" height="36"
                                                class="rounded" alt="">
                                            <div>
                                                <h5 class="lh--12 mb-2px color-3C3C3C">
                                    ...
                                    <div class="col-sm-6 col-lg-4 col-xxl-3">
                                        <div class="details-single d-flex align-items-center gap-2">
                                            <img src="{{ asset('assets/admin/img/icons/s-address.png') }}" width="36" height="36"
                                                class="rounded" alt="">
                                            <div>
                                                <h5 class="lh--12 mb-2px color-3C3C3C">
