...
<body>
    ...
    <div class="invoice-body">
        <div class="invoice-space">
                        ...
                        <div class="text-left header-info-right header-info-inner">
                            ...
                            <table class="fs-10">
                                <tr>
                                    ...
                                    <td>
                                        <span
                                            class="datas">{{ \App\CentralLogics\Helpers::format_currency($earnings->sum('original_delivery_charge') + $earnings->sum('dm_tips')) }}</span>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <span
                                            class="datas">{{ \App\CentralLogics\Helpers::format_currency($earnings->sum('original_delivery_charge'))}}</span>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <span
                                            class="datas">{{ \App\CentralLogics\Helpers::format_currency($earnings->sum('dm_tips'))}}</span>
                                    </td>
                                </tr>
                            </table>
                        </div>
            ...
            <p class="thanks-service text-center fs-10 mt-0 mb-0 py-6 text-clr">
                {{translate('Thanks for using our service.')}}</p>
        </div>
