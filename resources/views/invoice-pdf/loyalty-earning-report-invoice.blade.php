                        ...
                        <div class="text-left header-info-right header-info-inner">
                            ...
                            <table class="fs-10">
                                <tr>
                                    ...
                                    <td>
                                        <span
                                            class="datas">{{ \App\CentralLogics\Helpers::format_currency($earnings->sum('converted_amount')) }}</span>
                                    </td>
                                </tr>
                            </table>
                        </div>
                ...
                <tbody>
                    @foreach($earnings as $earning)
                        <tr>
                            ...
                            <td class="text-right">
                                <span>{{ \App\CentralLogics\Helpers::format_currency($earning->converted_amount) }}</span>
                            </td>
