...
<body class="footer-offset">
            ...
            <div class="col-md-12">
                <div id="loading" class="initial-hidden">
                    <div class="loader--inner">
                        <img width="80" src="{{asset('assets/admin/img/loader.gif')}}" alt="image">
                    </div>
                </div>
            </div>
        </div>
    ...
    <main id="content" role="main" class="main pointer-event">
        ...
        <div class="d-none" id="default-text-data"
            data-default-image-src="{{ asset('assets/admin/img/upload-img.png') }}"></div>
...
?>
        ...
        <audio id="safetyAlertAudio">
            <source src="{{asset('assets/admin/sound/safety-alert.mp3')}}" type="audio/mpeg">
        </audio>
        <script>
